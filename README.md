...
@devitools/cli/0.6.4 win32-x64 node-v12.18.4
$ devi --help [COMMAND]
USAGE
  $ devi COMMAND
...
...
_See code: [src/commands/add.ts](https://github.com/devitools/cli/blob/v0.6.4/src/commands/add.ts)_
...
_See code: [src/commands/init.ts](https://github.com/devitools/cli/blob/v0.6.4/src/commands/init.ts)_
<!-- commandsstop -->
